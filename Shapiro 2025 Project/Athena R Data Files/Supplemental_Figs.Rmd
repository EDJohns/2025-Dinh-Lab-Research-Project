...
load("/Volumes/hqdinh2/Projects/2.HNC_SPORE_SingleCell_Spatial/CosMX_TMA/CosMX_RNA_merged.rda")
...
load("/Volumes/hqdinh2-2/Projects/2.HNC_SPORE_SingleCell_Spatial/CosMX_TMA/Protein-data/Analysis/CosMX_protein_annot_cluster.rda")
...
CosMx_Protein_log_norm$merged_annot_cluster[colnames(CosMx_Protein_log_norm) %in% c(tregs)] <- 'New_Tregs'
CosMx_Protein_log_norm$merged_annot_cluster[colnames(CosMx_Protein_log_norm) %in% c(endo)] <- 'New_Endothelial_cells'
CosMx_Protein_log_norm$merged_annot_cluster[colnames(CosMx_Protein_log_norm) %in% c(nk)] <- 'New_NK_cells'
CosMx_Protein_log_norm$merged_annot_cluster[colnames(CosMx_Protein_log_norm) %in% c(tcells)] <- 'New_Tcells'
CosMx_Protein_log_norm$merged_annot_cluster[colnames(CosMx_Protein_log_norm) %in% c(neut)] <- 'New_Neutrophils'
CosMx_Protein_log_norm$merged_annot_cluster[colnames(CosMx_Protein_log_norm) %in% c(mac)] <- 'New_Macrophages'
...
load('/Volumes/hqdinh2-2/Projects/2.HNC_SPORE_SingleCell_Spatial/CosMX_TMA/CosMX_RNA_merged.rda')
